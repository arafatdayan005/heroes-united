                                                        ...
                                                        <div className="grid gap-6 mb-2 md:grid-cols-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" name='category'>
                                                                    {modalData.category == "Marvel" ? <option selected value="Marvel">Marvel</option> : ""}
                                                                    {modalData.category == "DC" ? <option selected value="DC">DC</option> : ""}
                                                                    {modalData.category == "The Boys" ? <option selected value="The Boys">The Boys</option> : ""}
                                                                </select>
                                                            </div>
                                                            <div>
